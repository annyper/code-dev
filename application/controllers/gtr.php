...
// ------------------AJAX ---------------------------------------
	function cargarModalTurnoAjax($terminal, $idTurno, $ipCifrada)
	{
		...
		$terminal = str_replace("_", " ", $terminal);
		...
		$this->load->view('gtr/turno_detalles',$col);
			...
			//echo "<pre>"; print_r($col['colas']); echo "</pre>";
		//}
	}
...
function getNSyPS($fecha, $ipCifrada){

	$this->inicializarModeloYdecodificarIP($ipCifrada);

	$data = $this->test_model->getNShistorico($fecha);
	echo $data;
		//echo "<pre>"; echo $data; echo "</pre>";
}

function getPS($fecha, $ipCifrada){

	$this->inicializarModeloYdecodificarIP($ipCifrada);

	$data = $this->test_model->getPShistorico($fecha);
	echo $data;
		//echo "<pre>"; echo $data; echo "</pre>";
}
