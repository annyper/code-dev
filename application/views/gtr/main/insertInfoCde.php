	...
	<?php echo form_open('gtr/insertInfoCde') ?>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<input type="text" required name="nombreTienda" placeholder="Escribe el nombre de la tienda" class="form-control">
				
				<label for="version">Horario de la Tienda</label>
				<input type="text" required name="horario" placeholder="Escribe el horario de la tienda" class="form-control">
